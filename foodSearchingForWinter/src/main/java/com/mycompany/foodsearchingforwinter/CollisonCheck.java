...
public class CollisonCheck {
    ...
    public void check(Object object){
        int obj_left_x = object.xpo;
        int obj_right_x = object.xpo+48;
        int obj_top_y = object.ypo;
        int obj_bottom_y = object.ypo+48; //origin 60 but doesn't work

        //actual col # and row # in the 2d map
        int map_left_col = obj_left_x/gp.tileSize;
        int map_right_col = obj_right_x/gp.tileSize;
        int map_top_row = obj_top_y/48; //origin 60
        int map_bottom_row = obj_bottom_y/48;  //origin 60

        int pixel_num1, pixel_num2;

        switch(object.direction){
            case "up":
                map_top_row = (obj_top_y-object.speed)/48; //origin 60
                ...
                break;
            case "down":
                map_bottom_row = ((obj_bottom_y+object.speed)/48); //origin 60
